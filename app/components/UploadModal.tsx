      ...
      <div className="flex items-center justify-center min-h-screen bg-black opacity-85 px-5">
        <div className="bg-[#272B43] rounded-2xl shadow-lg p-6 pb-10 w-full max-w-md relative opacity-100">
          ...
          <p className="text-white mb-4">
            ...
            If the uploaded track is not your authorship, it will be removed from the market. 
            For more information about the terms of use, <a href="/terms" className="text-[#5492FA] hover:text-white">Please read here.</a>
          </p>
          <p className="text-white">
            *By uploading a track, the Sacral Track - Artists agreement takes effect, where rights to the track are transferred to Sacral Track. The artist 
            have royalties amounting to 50% of the current price - $2.
          </p>
          <button
