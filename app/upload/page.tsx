...
const genres = ['Genres', 'Techno', 'K-pop', 'Deep', 'Hip-hop', 'Meditative', 'Electronic', 'Rave', 'House', 'DnB', 'Bass', 'Minimal', 'Lo-fi', 'Neurofunk', 'Psychedelic', 'Trap', 'Ambient', 'Acapella', 'Ai', 'Films', 'Games', 'Instrumental']; // Define your list of genres
                 ...
                 {isModalOpen && <UploadModal onClose={closeModal} />}
                    ...
                    <h2 className="text-gray-400">Artist name: {contextUser?.user?.name || 'Unknown Artist'}</h2>
                        ...
                        <div className="mt-4 sm:w-[566px] w-[180px] sm:mr-[20px] mr-5">
                            ...
                            <select className="bg-[#1E2136] justify-center sm:w-max-[180px] sm:border-[0.5px solid#1E2136] p-4 rounded-xl h-[52px] px-4 mt-4" value={genre} onChange={handleGenreChange}>
